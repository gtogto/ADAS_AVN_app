...
public class DeviceControlActivity extends Activity implements View.OnClickListener {
    ...
    final static String band_41a6_1 = "CD25C53041A6";
    public static String band_45eb = "F5:F4:E4:8A:45:EB";     //2nd Partron band
    public static String band_0cb9 = "D7:E9:E2:0B:A7:7E";     //2nd Partron band
    public static String band_d714 = "dd:76:ad:28:d7:14";     //2nd Partron band
    public static String band_9e25 = "D4:41:3D:6F:9E:25";     //3rd Partron band
    ...
    newAccSlidingCollection asc2 = new newAccSlidingCollection();
            ...
            public void run() {
                ...
                case1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        String band_41a6 = "F5:F4:E4:8A:45:EB";     //2nd Partron band
                        String band_0cb9 = "D7:E9:E2:0B:A7:7E";     //2nd Partron band
                        String band_d714 = "dd:76:ad:28:d7:14";     //2nd Partron band
                        String band_ef72 = "D5:77:CB:B1:EF:72";     //3rd Partron band
                        String band_9e25 = "D4:41:3D:6F:9E:25";     //3rd Partron band
                        ...
                        if (mDeviceAddress.equals(band_41a6) | mDeviceAddress.equals(band_ef72) | mDeviceAddress.equals(band_0cb9) |
                                mDeviceAddress.equals(band_9e25) | mDeviceAddress.equals(band_d714)) {
    ...
    private String getStringPacket(byte[] packet) {
        ...
        */
        ...
        System.out.println("[Partron Band original]>>> "+ " " + b_acc1 + " " + b_acc2+ " " + b_acc3+ " " + b_gyro1+ " " + b_gyro2+ " " + b_gyro3+ " " );
        System.out.println("[Partron Band]>>> "+ " " + b_ac_x + " " + b_ac_y+ " " + b_ac_z+ " " + b_gy_x+ " " + b_gy_y+ " " + b_gy_z+ " " );
        ...
        StringBuilder sb = new StringBuilder(packet.length * 2);
           ...
           result_2 = asc2.SlidingCollectionInterface (recv_sensors);
