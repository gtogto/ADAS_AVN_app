...
import com.example.android.bluetoothlegatt.com.newAccSlidingCollection;
...
public class music_main_activity extends Activity{
    ...
    public String band_45eb = "F5:F4:E4:8A:45:EB";     //2nd Partron band
    public String band_0cb9 = "D7:E9:E2:0B:A7:7E";     //2nd Partron band
    public String band_9e25 = "D4:41:3D:6F:9E:25";     //3rd Partron band
    */
    ...
    private String getStringPacket(byte[] packet) {
        ...
        //int result_2 = asc2.SlidingCollectionInterface (recv_sensors);
